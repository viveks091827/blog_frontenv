    ...
    <div className={styles.container}>
        ...
        <div className={styles.confirmationMessage}>
          ...
          <p className={styles.p}>
            Account with given email is exits. We have sent a confirmation email to your email address. Please check your inbox and follow the instructions to create your account.
          </p>
          <p className={styles.p}>
...
export default userExistsConfirmEmail;
